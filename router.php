...
$mainContent = str_replace('/goto.php?url=cm9zZGlwbG9tLnN1', 'https://'.$raskrutka_site_1.'/', $mainContent  );
$mainContent = str_replace('/goto.php?url=aHR0cHM6Ly9yb3NkaXBsb20uc3UvcmVmZXJlci5hc3B4P3JlZj1zdHVkZW50dQ==', 'https://'.$raskrutka_site_1.'/order.php', $mainContent  );
